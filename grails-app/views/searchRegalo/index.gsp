...
<html>
  ...
  <body>
    	...
    	<div class="container">
        	<div class="navbar-header">
        		<ul class="nav navbar-nav">
        			<li class="active"><a class="navbar-brand" href="#">Buscar Regalo</a></li>
        		</ul>	
        	</div>
	...
	<div id="respuesta_api_template" style="display:none;">
			...
			<form method="post" action="asignarRegalo">
    ...
    <script type="text/javascript">
      ...
      function agregarResultado(index, item) {
        ...
        str = str.replace("#idEmpleado", ${idEmp});
