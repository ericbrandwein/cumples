...
class EditController {
    ...
    def indexEmp() {
		...
		[nombre:emp.nombre, apellido:emp.apellido, dni:emp.dni, dia:emp.fechaNacimiento.getDay(), 
			mes:(emp.fechaNacimiento.getMonth()+1), anio:(emp.fechaNacimiento.getYear()+1900), 
			idEdEmp: emp.id]
	}
